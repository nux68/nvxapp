...
namespace nvxapp.server.data.Migrations
{
    ...
    [Migration("20250505124620_GestionePresenze_init")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("nvxapp.server.data.Entities.Tenant.Az_Reparto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("IdAz_Reparto");

                    b.HasIndex("IdAz_Sedi");

                    b.ToTable("Az_Reparto", "public");
                });

            modelBuilder.Entity("nvxapp.server.data.Entities.Tenant.Az_RepartoAttivita", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("Az_RepartoAttivita", "public");
                });

            modelBuilder.Entity("nvxapp.server.data.Entities.Tenant.Az_RepartoUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("Az_RepartoUser", "public");
                });
            ...
            modelBuilder.Entity("nvxapp.server.data.Entities.Tenant.Dip_GG_Richiesta", b =>
                {
                    ...
                    b.Property<string>("CronologiaApprovazione")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("nvxapp.server.data.Entities.Tenant.Az_Reparto", b =>
                {
                    b.HasOne("nvxapp.server.data.Entities.Tenant.Az_Reparto", "Az_RepartoNavigation")
                        .WithMany("Az_Reparto_Sub")
                        .HasForeignKey("IdAz_Reparto");
                    ...
                    b.Navigation("Az_RepartoNavigation");
            ...
            modelBuilder.Entity("nvxapp.server.data.Entities.Tenant.Az_Reparto", b =>
                {
                    b.Navigation("Az_RepartoAttivita");

                    b.Navigation("Az_RepartoUser");

                    b.Navigation("Az_Reparto_Sub");
                });

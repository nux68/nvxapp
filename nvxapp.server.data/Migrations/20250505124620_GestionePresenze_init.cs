    ...
    public partial class GestionePresenze_init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Az_RepartoUser", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Az_RepartoUser_AspNetUsers_AspNetUsersNavigationId",
                        column: x => x.AspNetUsersNavigationId,
                        principalSchema: "public",
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Az_RepartoUser_Az_Reparto_IdAz_Reparto",
                        column: x => x.IdAz_Reparto,
                        principalSchema: "public",
                        principalTable: "Az_Reparto",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Az_RepartoUser_AspNetUsersNavigationId",
                schema: "public",
                table: "Az_RepartoUser",
                column: "AspNetUsersNavigationId");

            migrationBuilder.CreateIndex(
                name: "IX_Az_RepartoUser_IdAz_Reparto",
                schema: "public",
                table: "Az_RepartoUser",
                column: "IdAz_Reparto");

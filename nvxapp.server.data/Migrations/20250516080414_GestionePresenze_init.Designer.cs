...
namespace nvxapp.server.data.Migrations
{
    ...
    [Migration("20250516080414_GestionePresenze_init")]
            ...
            modelBuilder.Entity("nvxapp.server.data.Entities.Tenant.Dip_GG_Richiesta", b =>
                {
                    ...
                    b.Property<List<Dip_GG_Richiesta_Stato_Cronology>>("RevocaApprovazioneData")
                        .IsRequired()
                        .HasColumnType("jsonb");
                    ...
                    b.Property<List<Dip_GG_Richiesta_Stato_Cronology>>("RichiestaApprovazioneData")
                        .IsRequired()
                        .HasColumnType("jsonb");

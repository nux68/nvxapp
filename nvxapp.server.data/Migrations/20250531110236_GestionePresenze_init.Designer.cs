...
namespace nvxapp.server.data.Migrations
{
    ...
    [Migration("20250531110236_GestionePresenze_init")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("nvxapp.server.data.Entities.Tenant.Az_Attivita", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("Az_Attivita", "public");
                });

            modelBuilder.Entity("nvxapp.server.data.Entities.Tenant.Az_AttivitaCompetenza", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("IdAz_Attivita");

                    b.ToTable("Az_AttivitaCompetenza", "public");
                });
            ...
            modelBuilder.Entity("nvxapp.server.data.Entities.Tenant.Az_Competenza", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("Az_Competenza", "public");
                });
            ...
            modelBuilder.Entity("nvxapp.server.data.Entities.Tenant.Dip_Competenza", b =>
                {
                    ...
                    b.Property<int>("IdAz_Competenza")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("nvxapp.server.data.Entities.Tenant.Az_AttivitaCompetenza", b =>
                {
                    b.HasOne("nvxapp.server.data.Entities.Tenant.Az_Attivita", "Az_AttivitaNavigation")
                        .WithMany("Az_AttivitaCompetenza")
                        .HasForeignKey("IdAz_Attivita")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Az_AttivitaNavigation");
                });
            ...
            modelBuilder.Entity("nvxapp.server.data.Entities.Tenant.Dip_Competenza", b =>
                {
                    b.HasOne("nvxapp.server.data.Entities.Tenant.Az_Competenza", "Az_CompetenzaNavigation")
                        .WithMany()
                        .HasForeignKey("IdAz_Competenza")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("Az_CompetenzaNavigation");
            ...
            modelBuilder.Entity("nvxapp.server.data.Entities.Tenant.Az_Attivita", b =>
                {
                    b.Navigation("Az_AttivitaCompetenza");
                });

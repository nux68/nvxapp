    ...
    public partial class GestionePresenze_init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Az_Attivita", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Az_Attivita_Az_Anagrafica_IdAz_Anagrafica",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Az_Competenza", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Az_Competenza_Az_Anagrafica_IdAz_Anagrafica",
                        column: x => x.IdAz_Anagrafica,
                        principalSchema: "public",
                        principalTable: "Az_Anagrafica",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                name: "Az_AttivitaCompetenza",
                schema: "public",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    IdAz_Attivita = table.Column<int>(type: "integer", nullable: false),
                    Descrizione = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    ModifiedDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    CreationDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    ChangeUser = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Az_AttivitaCompetenza", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Az_AttivitaCompetenza_Az_Attivita_IdAz_Attivita",
                        column: x => x.IdAz_Attivita,
                        principalSchema: "public",
                        principalTable: "Az_Attivita",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    IdDip_Anagrafica = table.Column<int>(type: "integer", nullable: false),
                    IdAz_Competenza = table.Column<int>(type: "integer", nullable: false),
                    ModifiedDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    CreationDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    ChangeUser = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Dip_Competenza_Az_Competenza_IdAz_Competenza",
                        column: x => x.IdAz_Competenza,
                        principalSchema: "public",
                        principalTable: "Az_Competenza",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Az_Attivita_IdAz_Anagrafica",
                schema: "public",
                table: "Az_Attivita",
                column: "IdAz_Anagrafica");

            migrationBuilder.CreateIndex(
                name: "IX_Az_AttivitaCompetenza_IdAz_Attivita",
                schema: "public",
                table: "Az_AttivitaCompetenza",
                column: "IdAz_Attivita");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Az_Competenza_IdAz_Anagrafica",
                schema: "public",
                table: "Az_Competenza",
                column: "IdAz_Anagrafica");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Dip_Competenza_IdAz_Competenza",
                schema: "public",
                table: "Dip_Competenza",
                column: "IdAz_Competenza");

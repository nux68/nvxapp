        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Descrizione = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    IdAz_Reparto = table.Column<int>(type: "integer", nullable: true),
                    ModifiedDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    CreationDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    ChangeUser = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Az_Reparto", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Az_Reparto_Az_Reparto_IdAz_Reparto",
                        column: x => x.IdAz_Reparto,
                        principalSchema: "public",
                        principalTable: "Az_Reparto",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Az_Reparto_Az_Sedi_IdAz_Sedi",
            ...
            migrationBuilder.CreateTable(
                name: "Az_RepartoAttivita",
                schema: "public",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    IdAz_Reparto = table.Column<int>(type: "integer", nullable: false),
                    Descrizione = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    ModifiedDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    CreationDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    ChangeUser = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Az_RepartoAttivita", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Az_RepartoAttivita_Az_Reparto_IdAz_Reparto",
                        column: x => x.IdAz_Reparto,
                        principalSchema: "public",
                        principalTable: "Az_Reparto",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RichiestaStato = table.Column<int>(type: "integer", nullable: false),
                    IdDip_Richiesta = table.Column<int>(type: "integer", nullable: true),
                    ModifiedDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    CreationDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    ChangeUser = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Dip_GG_Giustificativi_Dip_GG_Richieste_IdDip_Richiesta",
                        column: x => x.IdDip_Richiesta,
                        principalSchema: "public",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Dip_GG_Timbrature_Dip_GG_Richieste_IdDip_Richiesta",
                        column: x => x.IdDip_Richiesta,
                        principalSchema: "public",
                        principalTable: "Dip_GG_Richieste",
                        principalColumn: "Id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Az_Reparto_IdAz_Reparto",
                schema: "public",
                table: "Az_Reparto",
                column: "IdAz_Reparto");

            migrationBuilder.CreateIndex(
                name: "IX_Az_Reparto_IdAz_Sedi",
                schema: "public",
                table: "Az_Reparto",
                column: "IdAz_Sedi");

            migrationBuilder.CreateIndex(
                name: "IX_Az_RepartoAttivita_IdAz_Reparto",
                schema: "public",
                table: "Az_RepartoAttivita",
                column: "IdAz_Reparto");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Dip_GG_Giustificativi_IdDip_Richiesta",
                schema: "public",
                table: "Dip_GG_Giustificativi",
                column: "IdDip_Richiesta");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Dip_GG_Timbrature_IdDip_Richiesta",
                schema: "public",
                table: "Dip_GG_Timbrature",
                column: "IdDip_Richiesta");

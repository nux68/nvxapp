...
namespace nvxapp.server.data.Migrations
{
    ...
    [Migration("20260427125733_GestionePresenze_Commessa_4")]
    partial class GestionePresenze_Commessa_4
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("nvxapp.server.data.Entities.Tenant.Dip_GG_Result", b =>
                {
                    ...
                    b.Property<TimeOnly>("HH_Lav")
                        .HasColumnType("time without time zone");

                    b.Property<TimeOnly>("HH_Teo")
                        .HasColumnType("time without time zone");
            ...
            modelBuilder.Entity("nvxapp.server.data.Entities.Tenant.GestionePresenze.Par_ExportCau", b =>
                {
                    ...
                    b.ToTable("Par_ExportCau", "public");
                });
            ...
            modelBuilder.Entity("nvxapp.server.data.Entities.Tenant.GestionePresenze.Par_Orario", b =>
                {
                    ...
                    b.Property<int?>("IdAz_SubCommessaAttivita_MonteOre")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("IdAz_SubCommessaAttivita_MonteOre");
            ...
            modelBuilder.Entity("nvxapp.server.data.Entities.Tenant.GestionePresenze.Par_OrarioIntervalloHH", b =>
                {
                    ...
                    b.Property<int>("Alle_Arrotondamento")
                        .HasColumnType("integer");

                    b.Property<int>("Alle_Arrotondamento_Verso")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("Dalle_Arrotondamento")
                        .HasColumnType("integer");

                    b.Property<int>("Dalle_Arrotondamento_Verso")
                        .HasColumnType("integer");
                    ...
                    b.Property<bool>("Dalle_Use_4_Match")
                        .HasColumnType("boolean");

                    b.Property<int>("IdAz_SubCommessaAttivita")
                        .HasColumnType("integer");

                    b.Property<int>("IdCausale_HH_Lav")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("nvxapp.server.data.Entities.Tenant.GestionePresenze.Par_ProfiloOrario", b =>
                {
                    ...
                    b.Property<int>("IdCausale_Lavoro_Strao")
                        .HasColumnType("integer");

                    b.Property<int>("IdCausale_Lavoro_Suppl")
                        .HasColumnType("integer");

                    b.Property<int>("IdGiustificativo_Assenza_Ingiust")
                        .HasColumnType("integer");

                    b.Property<int>("IdPar_Orario_Festivo")
                        .HasColumnType("integer");
                    ...
                    b.Property<TimeOnly?>("StraoSogliaHHFullTime")
                        .HasColumnType("time without time zone");

                    b.Property<int>("StraoTipoConteggio")
                        .HasColumnType("integer");

                    b.Property<int>("SupplTipoConteggio")
                        .HasColumnType("integer");

                    b.Property<int>("TipoProfilo")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("IdCausale_Lavoro_Strao");

                    b.HasIndex("IdCausale_Lavoro_Suppl");

                    b.HasIndex("IdGiustificativo_Assenza_Ingiust");
            ...
            modelBuilder.Entity("nvxapp.server.data.Entities.Tenant.GestionePresenze.Par_Orario", b =>
                {
                    ...
                    b.HasOne("nvxapp.server.data.Entities.Tenant.Az_SubCommessaAttivita", "Az_SubCommessaAttivita_MonteOreNavigation")
                        .WithMany("Par_Orario")
                        .HasForeignKey("IdAz_SubCommessaAttivita_MonteOre")
                        .OnDelete(DeleteBehavior.Cascade);
                    ...
                    b.Navigation("Az_SubCommessaAttivita_MonteOreNavigation");
            ...
            modelBuilder.Entity("nvxapp.server.data.Entities.Tenant.GestionePresenze.Par_OrarioIntervalloHH", b =>
                {
                    ...
                    b.Navigation("Causale_HH_LavNavigation");
            ...
            modelBuilder.Entity("nvxapp.server.data.Entities.Tenant.GestionePresenze.Par_ProfiloOrario", b =>
                {
                    ...
                    b.HasOne("nvxapp.server.data.Entities.Tenant.Par_Causali", "Causale_Lavoro_StraoNavigation")
                        .WithMany()
                        .HasForeignKey("IdCausale_Lavoro_Strao")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("nvxapp.server.data.Entities.Tenant.Par_Causali", "Causale_Lavoro_SupplNavigation")
                        .WithMany()
                        .HasForeignKey("IdCausale_Lavoro_Suppl")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("nvxapp.server.data.Entities.Tenant.Par_Giustificativi", "Giustificativo_Assenza_IngiustNavigation")
                        .WithMany()
                        .HasForeignKey("IdGiustificativo_Assenza_Ingiust")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("nvxapp.server.data.Entities.Tenant.GestionePresenze.Par_Orario", "Par_Orario_FestivoNavigation")
                        .WithMany()
                        .HasForeignKey("IdPar_Orario_Festivo")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("Az_AnagraficaNavigation");

                    b.Navigation("Causale_Lavoro_StraoNavigation");

                    b.Navigation("Causale_Lavoro_SupplNavigation");

                    b.Navigation("Giustificativo_Assenza_IngiustNavigation");

                    b.Navigation("Par_Orario_FestivoNavigation");
                });
            ...
            modelBuilder.Entity("nvxapp.server.data.Entities.Tenant.Par_Giustificativi", b =>
                {
                    ...
                    b.HasOne("nvxapp.server.data.Entities.Tenant.Par_Causali", "Causale_Navigation")
                        .WithMany()
                        .HasForeignKey("IdCausale")
                        .OnDelete(DeleteBehavior.Restrict);

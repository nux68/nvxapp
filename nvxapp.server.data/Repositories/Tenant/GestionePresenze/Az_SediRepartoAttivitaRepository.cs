...
namespace nvxapp.server.data.Repositories.Tenant.GestionePresenze
{
    ...
    public class Az_SediRepartoAttivitaRepository : Repository<ApplicationDbContext, Az_SediRepartoAttivita>, IAz_SediRepartoAttivitaRepository, ICurrentTenant
    {
        ...
        public Az_SediRepartoAttivitaRepository(ApplicationDbContext dbContext,
